<template>
    <div class="todo-details">    
        <textarea ref="description" v-model="currentState(id).description" :readonly="!editing" @input="resize" @click.stop="toggleEditingMode" @focusout="toggleEditingMode"></textarea>
    </div>
</template>
